...
namespace APIRestPayment.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public MemberController(UserManager<CustomUserModel> userManager)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    result = UserManager.PasswordHasher.VerifyHashedPassword(user.Password ,model.Password);
                ...
                //string base64hashedPassword = Convert.ToBase64String(Encoding.UTF8.GetBytes(model.Password.GetHashCode().ToString()));
                //var user = await UserManager.FindAsync(model.UserEmail,base64hashedPassword);
                //if (user != null)
                //{
                //    await SignInAsync(user, model.RememberMe);
                //    return RedirectToLocal(returnUrl);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new CustomUserModel { Email = model.UserEmail };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new CustomUserModel { Email = model.UserName };
